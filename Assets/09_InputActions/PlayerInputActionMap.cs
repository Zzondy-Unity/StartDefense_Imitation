...
//     version 1.14.2
//     from Assets/09_InputActions/PlayerInputActionMap.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/09_InputActions/PlayerInputActionMap.inputactions".
/// </summary>
/// <remarks>
...
public partial class @PlayerInputActionMap: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""inputMap"",
            ""id"": ""18f4a299-92e3-48ec-ab95-a32ae73822b8"",
            ""actions"": [
                {
                    ""name"": ""mousePosition"",
                    ""type"": ""Value"",
                    ""id"": ""ff1a7faf-697c-4d0e-a6d9-b065e334c859"",
                ...
                },
                {
                    ""name"": ""mouseClick"",
                    ""type"": ""Button"",
                    ""id"": ""cf759243-c7c4-4d47-b93e-1612163a1889"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""bfef5430-d551-41df-b033-919280125a4b"",
                    ""path"": ""<Mouse>/position"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""1f0591a1-c076-4393-a506-3b1da66ae0f1"",
                ...
                {
                    ""name"": """",
                    ""id"": ""f0956ca5-76fd-4fe0-ac86-8a360f23229c"",
                ...
                {
                    ""name"": """",
                    ""id"": ""0c8ceb16-92cf-479a-83c7-9b1381a31cf6"",
    ...
    {
        UnityEngine.Debug.Assert(!m_inputMap.enabled, "This will cause a leak and performance issues, PlayerInputActionMap.inputMap.Disable() has not been called.");
    }
    ...
    /// <summary>
    /// Provides access to input actions defined in input action map "inputMap".
    /// </summary>
    public struct InputMapActions
    {
        ...
        /// </summary>
        public InputMapActions(@PlayerInputActionMap wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "inputMap/mousePosition".
        /// </summary>
        public InputAction @mousePosition => m_Wrapper.m_inputMap_mousePosition;
        /// <summary>
        /// Provides access to the underlying input action "inputMap/mouseClick".
        /// </summary>
        ...
        /// <summary>
        /// Implicitly converts an <see ref="InputMapActions" /> to an <see ref="InputActionMap" /> instance.
        /// </summary>
        ...
        /// <summary>
        /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="InputMapActions.UnregisterCallbacks(IInputMapActions)" />.
        /// </summary>
        /// <seealso cref="InputMapActions.UnregisterCallbacks(IInputMapActions)" />
        ...
        /// </remarks>
        /// <seealso cref="InputMapActions.AddCallbacks(IInputMapActions)" />
        /// <seealso cref="InputMapActions.RemoveCallbacks(IInputMapActions)" />
        /// <seealso cref="InputMapActions.UnregisterCallbacks(IInputMapActions)" />
    ...
    /// <summary>
    /// Provides a new <see cref="InputMapActions" /> instance referencing this action map.
    /// </summary>
    public InputMapActions @inputMap => new InputMapActions(this);
    /// <summary>
    /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "inputMap" which allows adding and removing callbacks.
    /// </summary>
    /// <seealso cref="InputMapActions.AddCallbacks(IInputMapActions)" />
    /// <seealso cref="InputMapActions.RemoveCallbacks(IInputMapActions)" />
